...
import {instanceOfUser, IUser} from "./User";
import {ValidationError} from "yup";
import {RootState} from "../../store";

export const registerUser = createAsyncThunk(
    "auth/register",
    async ({nickname, email, password}: UserRegData, {rejectWithValue}) => {
        try {
            let response = await AuthService.register(nickname, email, password);
...
export const getUserInfo = createAsyncThunk<IUser | ValidationError | any,
    void,
    {
        state: RootState;
